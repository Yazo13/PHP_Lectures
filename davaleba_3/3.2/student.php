<form method="post">
        <div class="parent">
            <input class="inp" type="text" name="name" placeholder="Name"><br><br>
            <span class="error"><?= $nameErr ?></span>

        </div>
        <div class="parent">
            <input class="inp" type="text" name="lastname" placeholder="Lastname"><br><br>
            <span class="error"><?= $lastnameErr ?></span>

        </div>
        <div class="parent">
            <input class="inp" type="text" name="email" placeholder="Email"><br><br>
